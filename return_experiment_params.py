...
def return_experiment_params(args):
    ...
    experiment = {'run_experiment':args.run_experiment,
                  'perform_RFE':False,
...
def return_vectors(use_error_in_fit):
    ...
    Stx_vars = ['x_image', 'y_image', 'r_eff','fwhm_world', 'a_world', 'b_world','theta_j2000', 'isoarea_world']

    Reddening_vars = ['ebv', 'ebv_err']

    training_quality = ['CLASS']

    independent_vec = data_quality+extra_photo_vars+Gaia_vars+Stx_vars+external_photo+Reddening_vars

    validation_vars = ['tile_id', 'number', 'alpha_j2000', 'delta_j2000', 'class_star', 'plx', 'pmra_g', 'pmde_g', 'gmag', 'bp_rp', 'mag_auto_uJAVAB', 'mag_auto_J0378B', 'mag_auto_J0395B', 'mag_auto_J0410B', 'mag_auto_J0430B', 'mag_auto_gSDSSB', 'mag_auto_J0515B', 'mag_auto_rSDSSB', 'mag_auto_J0660B', 'mag_auto_iSDSSB', 'mag_auto_J0861B', 'mag_auto_zSDSSB', 'mag_err_auto_uJAVAB', 'mag_err_auto_J0378B', 'mag_err_auto_J0395B', 'mag_err_auto_J0410B', 'mag_err_auto_J0430B', 'mag_err_auto_gSDSSB', 'mag_err_auto_J0515B', 'mag_err_auto_rSDSSB', 'mag_err_auto_J0660B', 'mag_err_auto_iSDSSB', 'mag_err_auto_J0861B', 'mag_err_auto_zSDSSB', 'ebv', 'ebv_err'] + training_quality + external_photo

    prediction_vars = ['tile_id', 'number', 'alpha_j2000', 'delta_j2000', 'class_star', 'plx', 'pmra_g', 'pmde_g', 'gmag', 'bp_rp', 'mag_auto_uJAVAB', 'mag_auto_J0378B', 'mag_auto_J0395B', 'mag_auto_J0410B', 'mag_auto_J0430B', 'mag_auto_gSDSSB', 'mag_auto_J0515B', 'mag_auto_rSDSSB', 'mag_auto_J0660B', 'mag_auto_iSDSSB', 'mag_auto_J0861B', 'mag_auto_zSDSSB', 'mag_err_auto_uJAVAB', 'mag_err_auto_J0378B', 'mag_err_auto_J0395B', 'mag_err_auto_J0410B', 'mag_err_auto_J0430B', 'mag_err_auto_gSDSSB', 'mag_err_auto_J0515B', 'mag_err_auto_rSDSSB', 'mag_err_auto_J0660B', 'mag_err_auto_iSDSSB', 'mag_err_auto_J0861B', 'mag_err_auto_zSDSSB', 'ebv', 'ebv_err'] + external_photo
